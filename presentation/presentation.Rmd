...
![Analysis count on condition](/cloud/project/results/06_analysis_iii_histogram_medicine_tumor.png){width=100%}

---

![Heatmap](/cloud/project/results/07_heatmap.png){width=100%}
