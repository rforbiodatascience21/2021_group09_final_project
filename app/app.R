...
server <- function(input, output) {
    ...
    field_tibble <- tibble(
        ...
        "Description" = c("The age of the patient in years.","The weight of the patient in kilograms.","At which age group did the patient start a natural menstrual cycle.",
                          ...
                          "History of breast cancer in the family", "The patients alcohol habits","Radiation therapy in the breast area",
        ...
        "Range/Values" = c("Range: 20 - 45","Range: 35 - 150", str_c("Categorical:","- Not Yet (cycle not started)", "- Under 12", "- Above 12",sep="<br>"),
                           "Range: 0-7",str_c("Categorical:","- Bening", "- Malignant",sep="<br>")," Illiterate=0, Elementary= 1, Middle School =2 , High School =3 , Diploma = 4, Associate =5 , Bachelor =6 , Master = 7",
