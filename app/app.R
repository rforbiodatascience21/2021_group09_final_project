    ...
    navbarPage( "Breast Cancer Survival Rate",
        tabPanel("Calculator",
                 sidebarPanel(tags$h3("User Input:"),
                     textInput("age", "Age:", 
                               "36"),
                     textInput("weight", "Weight (kg):", 
                               "60"),
                     selectInput("menstrual", "Menstrual Age:", 
                                 c("under 12","above 12","not yet")),
                     selectInput("given_birth", "Given Birth:", 
                                 c("0","1","2","3","4","5","6","7")),
                     selectInput("education", "Education level:", 
                                 c("Illiterate","Elementary","Middle School","High School","Diploma","Associate","Bachelor","Master"),
                                 "High School"),
