...
<div class="total_bar">
<div class="up_bar" style="width: 40px"></div><div class="arrow-right" style="margin-left: 40px"></div>
</div><br>
...
<div class="total_bar">
<div class="up_bar" style="width: 60px"></div><div class="arrow-right" style="margin-left: 60px"></div>
</div><br>
...
<div class="total_bar">
<div class="up_bar" style="width: 80px"></div><div class="arrow-right" style="margin-left: 80px"></div>
</div><br>
...
<div class="total_bar">
<div class="up_bar" style="width: 100px"></div><div class="arrow-right" style="margin-left: 100px"></div>
</div><br>
...
<div class="total_bar">
<div class="up_bar" style="width: 120px"></div><div class="arrow-right" style="margin-left: 120px"></div>
</div><br>
...
## Distributions {#slide}
```{r out.width = "85%", fig.show = 'hold', fig.align = 'center'}
...
<div class="total_bar">
<div class="up_bar" style="width: 320px"></div><div class="arrow-right" style="margin-left: 320px"></div>
</div><br>
...
redMod_tumor %>%
  ...
  select(-class) %>%
  mutate(across(-model, function(x) str_c(round(x*100),"%"))) %>%
  rename_with(.fn = function(x) str_replace(x, "_", " ") %>% str_to_sentence()) %>%
  kbl("html") %>%
  kable_minimal() %>%
  kable_styling(font_size = 20) %>%
...
<div class="total_bar">
<div class="up_bar" style="width: 340px"></div><div class="arrow-right" style="margin-left: 340px"></div>
</div><br>
...
<div class="total_bar">
<div class="up_bar" style="width: 360px"></div><div class="arrow-right" style="margin-left: 360px"></div>
</div><br>
...
<div class="total_bar">
<div class="up_bar" style="width: 380px"></div><div class="arrow-right" style="margin-left: 380px"></div>
</div><br>
